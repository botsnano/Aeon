...
class _BotCommands:
    def __init__(self):
        ...
        self.LeechCommand = [f'leech{CMD_SUFFIX}', f'la{CMD_SUFFIX}']
        self.YtdlLeechCommand = [f'ytdlleech{CMD_SUFFIX}', f'yla{CMD_SUFFIX}']
        ...
        self.StatusCommand = [f'status{CMD_SUFFIX}', 'statusall','sa']
        ...
        self.RestartCommand = [f'restart{CMD_SUFFIX}', 'restartall', 'ra']
